  ...
  return (
    <div className="h-[90vh]">
      ...
      <div className="bannerMiniContainer px-36 ">
        <p className=" text-5xl font-bold text-white w-[25rem] mb-5">
        ...
        <div className=" bg-white pt-5">
          <div className="flex items-center justify-around">
            ...
            <div onClick={()=>router.push("/")} className="searchOlaCabButton cursor-pointer flex items-center py-4 px-14 border border-slate-900 justify-around">
